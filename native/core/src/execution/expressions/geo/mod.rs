...
pub fn register_geo_functions(ctx: &SessionContext) {
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_make_envelope::StMakeEnvelope::default(),
    ));
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_covered_by::StCoveredBy::default(),
    ));
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_distance_sphere::StDistanceSphere::default(),
    ));
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_perimeter::StPerimeter::default(),
    ));
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_hausdorff_distance::StHausdorffDistance::default(),
    ));
    // Transformations
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_simplify_preserve_topology::StSimplifyPreserveTopology::default(),
    ));
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_flip_coordinates::StFlipCoordinates::default(),
    ));
    ...
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_difference::StDifference::default(),
    ));
    ctx.register_udf(ScalarUDF::new_from_impl(
        st_sym_difference::StSymDifference::default(),
    ));
    // Accessors
