...
class CometSparkSessionExtensions
  ...
  override def apply(extensions: SparkSessionExtensions): Unit = {
    ...
    extensions.injectFunction(GeoExpressions.stGeomFromWktInfo)
    extensions.injectFunction(GeoExpressions.stGeomFromGeoJsonInfo)
    extensions.injectFunction(GeoExpressions.stPointInfo)
    extensions.injectFunction(GeoExpressions.stMakeEnvelopeInfo)
    extensions.injectFunction(GeoExpressions.stMakeLineInfo)
    extensions.injectFunction(GeoExpressions.stAsTextInfo)
    extensions.injectFunction(GeoExpressions.stAsGeoJsonInfo)
    extensions.injectFunction(GeoExpressions.stCoversInfo)
    extensions.injectFunction(GeoExpressions.stCoveredByInfo)
    extensions.injectFunction(GeoExpressions.stEqualsInfo)
    extensions.injectFunction(GeoExpressions.stTouchesInfo)
    extensions.injectFunction(GeoExpressions.stCrossesInfo)
    extensions.injectFunction(GeoExpressions.stDisjointInfo)
    extensions.injectFunction(GeoExpressions.stOverlapsInfo)
    extensions.injectFunction(GeoExpressions.stDistanceSphereInfo)
    extensions.injectFunction(GeoExpressions.stPerimeterInfo)
    extensions.injectFunction(GeoExpressions.stHausdorffDistanceInfo)
    extensions.injectFunction(GeoExpressions.stSimplifyPreserveTopologyInfo)
    extensions.injectFunction(GeoExpressions.stFlipCoordinatesInfo)
